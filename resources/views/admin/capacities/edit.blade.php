    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <span style="font-size: 25px" class="m-0 font-weight-bold text-primary">Edit Capacity</span>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1">Form Capacity</h4>
                                    </div><!-- end card header -->
                                    <div class="card-body">

                                        <div class="form-group">
                                            <label for="cap_name">Name <span class="text-danger">*</span></label>
                                            <input type="text" value="{{ old('cap_name', $data->cap_name) }}" name="cap_name"
                                                id="cap_name" class="form-control" required>
                                        </div>
